...
# installed.
TCL_PREFIX='/home/user/ns-allinone-2.35'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/user/ns-allinone-2.35'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/user/ns-allinone-2.35/tcl8.5.10/unix -ltcl8.5'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/user/ns-allinone-2.35/lib -ltcl8.5'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/user/ns-allinone-2.35/include'
...
# compiled.
TCL_SRC_DIR='/home/user/ns-allinone-2.35/tcl8.5.10'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/home/user/ns-allinone-2.35/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/user/ns-allinone-2.35/tcl8.5.10/unix -ltclstub8.5'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/user/ns-allinone-2.35/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/user/ns-allinone-2.35/tcl8.5.10/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/user/ns-allinone-2.35/lib/libtclstub8.5.a'
